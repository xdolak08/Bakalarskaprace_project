package com.example.semestralproject.CryptoPrimitives;
...
public class CryptoPrimitives extends AppCompatActivity {
    ...
    public void Selected(View View)
    {
        ...
        if (button_text.equals("QR"))
        {
            Intent mass2 = new Intent(this, QR.class);
            startActivity(mass2);

        }
        else if (button_text.equals("Firebase"))
        {
            Intent mass3 = new Intent(this, Login.class);
            startActivity(mass3);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crypto_primitives);
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        Intent intent = new Intent(CryptoPrimitives.this, MainActivity.class);
                        startActivity(intent);
                        break;

                    case R.id.crypto:
                        Toast.makeText(CryptoPrimitives.this, "Jste zde.", Toast.LENGTH_SHORT).show();

                        break;

                    case R.id.qr:
                        Intent intent2 = new Intent(CryptoPrimitives.this, QR.class);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (selectedIdleft == radioCBC.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste CBC", Toast.LENGTH_LONG).show();
                        mereni();
                        ...
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste ECB", Toast.LENGTH_LONG).show();
                        outputString = ECBencrypt(inputText.getText().toString(), inputKey.getText().toString());
                        finalText.setText(outputString);
                    } else if (selectedIdleft == radioGCM.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste GCM", Toast.LENGTH_LONG).show();
                        outputString = GCMencrypt(inputText.getText().toString());
                        finalText.setText(outputString);
                    } else if (selectedIdleft == radioCTR.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste CTR", Toast.LENGTH_LONG).show();
                        outputString = CTRencrypt(inputText.getText().toString(), inputKey.getText().toString());
                        finalText.setText(outputString);
                    } else if (selectedIdright == radioRSA.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste RSA", Toast.LENGTH_LONG).show();
                        outputString = RSAencrypt(inputText.getText().toString());
                        finalText.setText(outputString);
                        radioGroupRight.clearCheck();
                    } else if (selectedIdright == radioSHA256.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste SHA-256", Toast.LENGTH_LONG).show();
                        outputString = sha256String(inputText.getText().toString());
                        finalText.setText(outputString);
                        radioGroupRight.clearCheck();
                    } else
                        Toast.makeText(CryptoPrimitives.this, "Nebyla vybrána šifra!", Toast.LENGTH_LONG).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (selectedId == radioECB.getId()) {
                        Toast.makeText(CryptoPrimitives.this,
                        ...
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste dešifrování RSA",
                                Toast.LENGTH_LONG).show();
                        outputString = RSAdecrypt(outputString);
                        finalText.setText(outputString);
                    } else if (selectedId == radioCBC.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste dešifrování CBC",
                                Toast.LENGTH_LONG).show();
                        outputString = CBCdecrypt(outputString, CBCkey, iv);
                        finalText.setText(outputString);
                        radioGroupLeft.clearCheck();
                    } else if (selectedId == radioGCM.getId()) {
                        Toast.makeText(CryptoPrimitives.this, "Vybrali jste dešifrování GCM",
                                Toast.LENGTH_LONG).show();
                        outputString = GCMdecrypt(outputString);
                        finalText.setText(outputString);
                        radioGroupLeft.clearCheck();
                    } else Toast.makeText(CryptoPrimitives.this, "Nebyla vybrána šifra!",
                            Toast.LENGTH_LONG).show();
